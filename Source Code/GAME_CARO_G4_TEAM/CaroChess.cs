...
namespace GAME_CARO_G4_TEAM
{
    ...
    class CaroChess 
    {
        ...
        private long DiemTanCong_DuyetDoc(int iDong, int iCot)
        {
            ...
            //
            for (int dem = 1; dem < 6 && iDong + dem < _BanCo.NumDong; dem++)
            {
                ...
                {
                    for (int dem2 = 2; dem2 < 7 && iDong + dem2 < _BanCo.NumDong; dem2++)
            ...
            for (int dem = 1; dem < 6 && iDong - dem >= 0; dem++)
            {
                if (MangOCo[iDong - dem, iCot].SoHuu == 1)
                {
                    SoQuanTa++;
                ...
                {
                    for (int dem2 = 2; dem2 < 7 && iDong - dem2 >= 0; dem2++)
                        if (MangOCo[iDong - dem2, iCot].SoHuu == 1)
                        {
                            SoQuanTa2++;
                        }
        ...
        private long DiemTanCong_DuyetNgang(int iDong, int iCot)
        {
            ...
            //
            for (int dem = 1; dem < 6 && iCot + dem < _BanCo.NumCot; dem++)
            {
                ...
                {
                    for (int dem2 = 2; dem2 < 7 && iCot + dem2 < _BanCo.NumCot; dem2++)
            ...
            for (int dem = 1; dem < 6 && iCot - dem >= 0; dem++)
            {
                if (MangOCo[iDong, iCot - dem].SoHuu == 1)
                {
                    SoQuanTa++;
                ...
                {
                    for (int dem2 = 2; dem2 < 7 && iCot - dem2 >= 0; dem2++)
                        if (MangOCo[iDong, iCot - dem2].SoHuu == 1)
                        {
                            SoQuanTa2++;
                        }
        ...
        private long DiemTanCong_DuyetCheoXuoi(int iDong, int iCot)
        {
            ...
            //
            for (int dem = 1; dem < 6 && iCot + dem < _BanCo.NumCot && iDong + dem < _BanCo.NumDong; dem++)
            {
                ...
                {
                    for (int dem2 = 2; dem2 < 7 && iCot + dem2 < _BanCo.NumCot && iDong + dem2 < _BanCo.NumDong; dem2++)
            ...
            for (int dem = 1; dem < 6 && iCot - dem >= 0 && iDong - dem >= 0; dem++)
            {
                if (MangOCo[iDong - dem, iCot - dem].SoHuu == 1)
                {
                    SoQuanTa++;
                ...
                {
                    for (int dem2 = 2; dem2 < 7 && iCot - dem2 >= 0 && iDong - dem2 >= 0; dem2++)
                        if (MangOCo[iDong - dem2, iCot - dem2].SoHuu == 1)
                        {
                            SoQuanTa2++;
                        }
        ...
        private long DiemTanCong_DuyetCheoNguoc(int iDong, int iCot)
        {
            ...
            //
            for (int dem = 1; dem < 6 && iCot + dem < _BanCo.NumCot && iDong - dem > 0; dem++)
            {
                if (MangOCo[iDong - dem, iCot + dem].SoHuu == 1)
                {
                    SoQuanTa++;
                ...
                {
                    for (int dem2 = 2; dem2 < 7 && iCot + dem2 < _BanCo.NumCot && iDong - dem2 > 0; dem2++)
                        if (MangOCo[iDong - dem2, iCot + dem2].SoHuu == 1)
                        {
                            SoQuanTa2++;
                        }
            ...
            for (int dem = 1; dem < 6 && iCot - dem >= 0 && iDong + dem < _BanCo.NumDong; dem++)
            {
                if (MangOCo[iDong + dem, iCot - dem].SoHuu == 1)
                {
                    SoQuanTa++;
                ...
                {
                    for (int dem2 = 1; dem2 < 7 && iCot - dem2 >= 0 && iDong + dem2 < _BanCo.NumDong; dem2++)
                        if (MangOCo[iDong + dem2, iCot - dem2].SoHuu == 1)
                        {
                            SoQuanTa2++;
                        }
        ...
        private long DiemPhongNgu_DuyetCheoXuoi(int iDong, int iCot)
        {
            ...
            for (int dem = 1; dem < 6 && iCot + dem < _BanCo.NumCot && iDong + dem < _BanCo.NumDong; dem++)
            {
                ...
                {
                    for (int dem2 = 2; dem2 < 7 && iDong + dem2 < _BanCo.NumDong && iCot + dem2 < _BanCo.NumCot; dem2++)
                        if (MangOCo[iDong + dem2, iCot + dem2].SoHuu == 1)
                        {
                            SoQuanTa2++;
                            break;
        ...
        private long DiemPhongNgu_DuyetCheoNguoc(int iDong, int iCot)
        {
            ...
            for (int dem = 1; dem < 6 && iCot + dem < _BanCo.NumCot && iDong - dem > 0; dem++)
            {
                ...
                {
                    for (int dem2 = 2; dem2 < 7 && iDong - dem2 >= 0 && iCot + dem2 < _BanCo.NumCot; dem2++)
                        if (MangOCo[iDong - dem2, iCot + dem2].SoHuu == 1)
                        {
                            SoQuanTa2++;
                            break;
            ...
            for (int dem = 1; dem < 6 && iCot - dem >= 0 && iDong + dem < _BanCo.NumDong; dem++)
            {
                ...
                {
                    for (int dem2 = 2; dem2 < 7 && iDong + dem2 < _BanCo.NumDong && iCot - dem2 >= 0; dem2++)
                        if (MangOCo[iDong + dem2, iCot - dem2].SoHuu == 1)
                        {
                            SoQuanTa2++;
                            break;
